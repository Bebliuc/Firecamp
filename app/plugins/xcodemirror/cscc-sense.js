...
var csccSense =
{
  ...
  // autoSelfClosers are taken directly from CodeMirror parsexml.js
  autoSelfClosers: "br,img,hr,link,input,meta,col,frame,base,area".split(","),

  isSelfClose: function (a) {
      d = 0;
      for (e = csccSense.autoSelfClosers.length; d < e; d++) if (csccSense.autoSelfClosers[d] == a) return true;
      return false
  },
