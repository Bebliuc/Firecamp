<?php
	...
	class Plot {
		...
		public function createImage() {
			...
			$this->backGroundColor = new Color(153, 0, 0);
			$this->textColor = $this->palette->qdColors[0];
           
			$black = imagecolorallocate($this->img, $this->palette->qdColors[1]->red, $this->palette->qdColors[1]->green, $this->palette->qdColors[1]->blue);
			
			imagecolortransparent($this->img, $black);
			imagefilledrectangle($this->img, 0, 0, $this->width - 1, $this->height - 1, $black);
