...
qq.FileUploader = function(o){
    this._options = {
        ...
        template: '<div class="qq-uploader">' + 
                ...
                '<div class="qq-upload-button">Browse for image</div>' +
                '<ul class="qq-upload-list"></ul>' + 
             '</div>',

        // template for one item in file list
        fileTemplate: '<li>' + 
                '<sup class="role user-type-yellow"><a href="#" class="qq-upload-file"></a></sup>' + 
                '<sup class="role user-type-invited"><a href="#" class="qq-upload-size"></a></sup>' + 
                '<sup class="role user-type-invited"><a href="#" class="qq-upload-cancel"></a></sup>' + 
